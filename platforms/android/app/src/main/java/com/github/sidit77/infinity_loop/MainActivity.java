package com.github.sidit77.infinity_loop;
...
public class MainActivity extends GameActivity {
    ...
    static {
        ...
        System.loadLibrary("infinity_loop_android");
    }
    ...
    private void hideSystemUI() {
        ...
        if (VERSION.SDK_INT >= VERSION_CODES.R) {
            ...
            Arrays.stream(getDisplay().getSupportedModes())
                    .max(Comparator.comparing(Display.Mode::getRefreshRate))
                    .ifPresent(m -> {
                        Log.i("FRAMERATE", "high " + m.getRefreshRate() + "  " + m.getModeId());
                        getWindow().getAttributes().preferredDisplayModeId = m.getModeId();
                    });
        }
